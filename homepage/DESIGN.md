...
4. **Compute vs Track** — two columns. COMPUTE (hero): LL97 verified fine + funded fix-it plan, 40+ BPS cities. TRACK (breadth): FISP/LL11, LL84, LL33/95, LL152, boiler/elevator — deadlines & status. Principle line: "Your LL97 fine, figured from real emissions. Every other deadline, dated to the day. Never a made-up number."
