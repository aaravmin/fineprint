...
- **Type pairing** (guardrail: display ≠ body): display = a bold geometric grotesk (e.g. *Space Grotesk* / *Archivo*), body = *Inter*. Tight tracking (`-0.03em`) on large headings; body line-height `1.7`. `tabular-nums` on every number.
