          ...
          <header className="sticky top-0 z-50 border-b border-border/70 bg-background/80 backdrop-blur-md">
            <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
              ...
              <div className="flex items-center gap-2">
                ...
                <Sheet>
                  <SheetTrigger
                    className="fp-press inline-flex size-10 items-center justify-center rounded-full border border-border bg-card md:hidden"
          ...
          <section className="relative overflow-hidden">
            ...
            >
              ...
              <motion.div variants={rise}>
                <h1 className="font-heading text-[clamp(2.75rem,9vw,7.5rem)] font-bold leading-none tracking-tight">
                  READ THE
                </h1>
              </motion.div>
              ...
              <motion.div variants={rise} className="mt-1 md:mt-2">
                <p className="font-heading text-[clamp(2.75rem,9vw,7.5rem)] font-bold leading-none tracking-tight">
              ...
              <motion.div variants={rise} className="mt-1 md:mt-2">
                <p className="font-heading flex items-baseline whitespace-nowrap text-[clamp(2.75rem,9vw,7.5rem)] font-bold leading-none tracking-tight">
                  SKIP&nbsp;THE&nbsp;
              ...
              <motion.div variants={rise} className="mt-8 md:mt-12">
                ...
                <div className="mt-4 flex flex-col gap-2 text-muted-foreground md:flex-row md:items-baseline md:justify-between">
                  ...
                  <span className="flex items-baseline gap-3">
                    <span className="text-lg font-thin tracking-wide text-foreground md:text-2xl">
                      FINE RATE
                    </span>
          ...
          <StickyTabs>
            ...
            <StickyTabs.Item title="03 / The ops room" id="ops">
              ...
              >
                ...
                <motion.div variants={rise} className="flex justify-center pb-16 pr-8">
