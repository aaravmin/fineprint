...
export function FineprintLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="90 140 300 220" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
      <path
        ...
        fill="currentColor"
      />
      <path d="M166.443 273.592L274.301 156.768L305.16 185.259L197.302 302.083L166.443 273.592Z" fill="currentColor" />
      <path
