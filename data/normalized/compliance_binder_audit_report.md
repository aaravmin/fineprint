...
- LL96 (PACE) and LL55 carry empty _required_ lists by design — PACE is an opportunity, and LL55 has no DOB filing — so their proof is recommended_evidence, never invented as required.
...
- PASS — obligation can be assigned a vendor (vendor_id column)
- PASS — evidence stores proof files (file_name / file_url_or_key)
- PASS — evidence maps to an obligation and a law
- PASS — function "seed_obligations" exists
- PASS — function "add_vendor" exists
- PASS — function "assign_vendor" exists
- PASS — function "set_obligation_status" exists
- PASS — function "add_evidence" exists
- PASS — function "set_evidence_verification" exists
- PASS — function "add_binder_note" exists
