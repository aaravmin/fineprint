...
const MEASURES: NycCostMeasure[] = [
  ...
  range("Whole-home electrification, air-source heat pump", "Residential — single family", 17_400, 31_700,
    sfHome(9, "Full appliance set (heat pump/AC, heat-pump water heater, cooktop, clothes dryer) plus electrical modifications.")),
  range("Whole-home electrification, ground-source heat pump", "Residential — single family", 28_400, 50_500,
    sfHome(10, "Full appliance set plus electrical modifications; ground-source.")),
  range("Air-source heat pump and AC", "Residential — single family", 13_000, 20_000,
    sfHome(10, "Largest single component of a home retrofit.")),
  range("Ground-source heat pump and AC", "Residential — single family", 24_000, 38_800,
    sfHome(10, "Largest single component; ground-source.")),
  range("Heat-pump water heater", "Residential — single family", 900, 4_000, sfHome(11, "RCG Estimate row, appliance cost table.")),
  range("Electric / induction cooktop range", "Residential — single family", 400, 1_200, sfHome(11, "RCG Estimate row; $400 standard electric, up to $1,200 induction.")),
  range("Heat-pump clothes dryer", "Residential — single family", 500, 1_500, sfHome(11, "RCG Estimate row.")),
  range("Electrical service modifications", "Residential — single family", 2_600, 5_000, sfHome(11, "Panel/service upgrade and wiring for added electric loads.")),

  // --- Electrification report: multifamily, per unit (p. 11) ---
  range("Whole-unit electrification, air/water-source heat pump", "Residential — small multifamily (2-19 units)", 13_000, 30_100,
    mfUnit(11, "Per dwelling unit; full appliance set plus electrical modifications.")),
  range("Whole-unit electrification, air/water-source heat pump", "Residential — large multifamily (20+ units)", 19_400, 42_900,
    mfUnit(11, "Per dwelling unit; full appliance set plus electrical modifications.")),
  range("Whole-unit electrification, ground-source heat pump", "Residential — small multifamily (2-19 units)", 29_600, 42_900,
    mfUnit(11, "Per dwelling unit; ground-source.")),
  range("Whole-unit electrification, ground-source heat pump", "Residential — large multifamily (20+ units)", 40_800, 56_000,
    mfUnit(11, "Per dwelling unit; ground-source.")),

  // --- Electrification report: office, per square foot (p. 14) ---
  point("Building envelope, basic shell upgrade", "Commercial — office", 16, officeSqft("Reference shell baseline is $4/ft²; basic shell upgrade.")),
  point("Building envelope, deep shell upgrade", "Commercial — office", 28, officeSqft("Deep shell upgrade.")),
  point("Heat-pump water heater (office)", "Commercial — office", 2, officeSqft("High-end estimate.")),
  point("Electrical and infrastructure upgrades (office)", "Commercial — office", 0.4, officeSqft("Infrastructure/electrical upgrade for electrification.")),

  // --- Electrification report: new construction (p. 14) ---
  range("Whole-home electrification, new construction (incremental)", "Residential — single family (new construction)", 12_000, 23_000, {
    unit: "2022 USD, incremental total per single-family home",
    pdf: ELECTRIFICATION,
    page: 14,
    notes: "RCG synthesized New York estimate, 2022. Incremental construction cost vs a standard gas-powered new home; full appliance set plus electrical modifications.",
  }),

  // --- Steam report: Table 6A, Distribution Improvements Package (p. 28) ---
  point("Steam distribution improvements package", "Residential one-pipe steam (~5,000 ft²)", 6_000, steam6a("Annual savings $0.13/ft² (gas) to $0.23/ft² (oil); simple payback 6-10 yr.")),
  point("Steam distribution improvements package", "Residential one-pipe steam (~50,000 ft²)", 40_250, steam6a("Annual savings $0.09/ft² (gas) to $0.23/ft² (oil); simple payback 4-9 yr.")),
  point("Steam distribution improvements package", "Residential one-pipe steam (~200,000 ft²)", 96_000, steam6a("Annual savings $0.08/ft² (gas) to $0.20/ft² (oil); simple payback 3-6 yr.")),
  point("Steam distribution improvements package", "Residential two-pipe steam (~5,000 ft²)", 6_000, steam6a("Annual savings $0.16/ft² (gas) to $0.40/ft² (oil); simple payback 3-8 yr.")),
  point("Steam distribution improvements package", "Residential two-pipe steam (~50,000 ft²)", 56_000, steam6a("Annual savings $0.09/ft² (gas) to $0.23/ft² (oil); simple payback 5-12 yr.")),
  point("Steam distribution improvements package", "Residential two-pipe steam (~200,000 ft²)", 152_000, steam6a("Annual savings $0.09/ft² (gas) to $0.22/ft² (oil); simple payback 4-9 yr.")),
  point("Steam distribution improvements package", "Commercial two-pipe steam (~20,000 ft²)", 9_750, steam6a("Annual savings $0.02/ft² (gas); simple payback 7 yr.")),
  point("Steam distribution improvements package", "Commercial two-pipe steam (~90,000 ft²)", 97_500, steam6a("Annual savings $0.08/ft² (gas); simple payback 14 yr.")),
  point("Steam distribution improvements package", "Commercial two-pipe steam (~250,000 ft²)", 186_000, steam6a("Annual savings $0.08/ft² (gas) to $0.26/ft² (district steam); simple payback 3-9 yr.")),

  // --- Steam report: Table 6B, Boiler Replacement Package (p. 29) ---
  point("Right-sized steam boiler replacement", "Residential one-pipe steam (~5,000 ft²)", -5_750, steam6b("Annual savings $0.09/ft² (gas) to $0.15/ft² (oil); immediate payback.")),
  plusMinus("Right-sized steam boiler replacement", "Residential one-pipe steam (~50,000 ft²)", -12_000, 500, steam6b("Annual savings $0.04/ft² (gas) to $0.09/ft² (oil).")),
  plusMinus("Right-sized steam boiler replacement", "Residential one-pipe steam (~200,000 ft²)", -39_250, 4_000, steam6b("Annual savings $0.02/ft² (gas) to $0.06/ft² (oil).")),
  point("Right-sized steam boiler replacement", "Residential two-pipe steam (~5,000 ft²)", -5_750, steam6b("Annual savings $0.12/ft² (gas) to $0.30/ft² (oil).")),
  plusMinus("Right-sized steam boiler replacement", "Residential two-pipe steam (~50,000 ft²)", -12_000, 500, steam6b("Annual savings $0.03/ft² (gas) to $0.08/ft² (oil).")),
  plusMinus("Right-sized steam boiler replacement", "Residential two-pipe steam (~200,000 ft²)", -39_250, 4_000, steam6b("Annual savings $0.03/ft² (gas) to $0.08/ft² (oil).")),
  point("Right-sized steam boiler replacement", "Commercial two-pipe steam (~20,000 ft²)", 500, steam6b("Annual savings $0.01/ft² (gas).")),
  plusMinus("Right-sized steam boiler replacement", "Commercial two-pipe steam (~90,000 ft²)", -12_000, 500, steam6b("Annual savings $0.02/ft² (gas).")),
  plusMinus("Right-sized steam boiler replacement", "Commercial two-pipe steam (~250,000 ft²)", -39_250, 4_000, steam6b("Annual savings $0.02/ft² (gas) to $0.07/ft² (district steam).")),

  // --- Spending Through the Roof: radiator-vent heat-loss control (p. 17) ---
  range("Cover radiator vents with storm/annealed glass", "Multifamily steam-heated (any size)", 500, 2_000, roofVent("Covers ~2/3 of vents; in-house installable; best for smaller, simpler buildings.")),
  range("Install mechanical damper on radiator vents", "Multifamily steam-heated (any size)", 5_000, 15_000, roofVent("Fully closes the vent; requires electrical power and wiring.")),
];
...
const FIELDS: Array<keyof NycCostMeasure> = [
  "measure_name", "building_type", "cost_low", "cost_mid", "cost_high", "cost_unit",
  "energy_savings", "carbon_savings", "lifetime_years", "source_pdf", "page_number", "notes",
];
...
function validate(measures: NycCostMeasure[]): string[] {
  ...
  measures.forEach((measure, index) => {
    for (const field of FIELDS) {
      if (!(field in measure)) {
        problems.push(`measure ${index} (${measure.measure_name}) missing field ${field}`);
      }
    }
    if (!measure.source_pdf || !measure.page_number) {
      problems.push(`measure ${index} (${measure.measure_name}) lacks source_pdf or page_number`);
    }
    const hasCost = measure.cost_low !== null || measure.cost_mid !== null || measure.cost_high !== null;
    if (!hasCost) {
      problems.push(`measure ${index} (${measure.measure_name}) has no cost value at all`);
    }
  });
  return problems;
}
